...
ARG EXTENSION_SWOOLE_VERSION=4.4.17
ARG EXTENSION_UUID_VERSION=1.1.0
ARG EXTENSION_YAML_VERSION=2.1.0
ARG EXTENSION_JSONNET_VERSION=1.3.1
ARG EXTENSION_PROTOBUF_VERSION=3.11.4
ARG EXTENSION_IGBINARY_VERSION=3.1.1
ARG EXTENSION_MSGPACK_VERSION=2.1.0
ARG EXTENSION_MAILPARSE_VERSION=3.0.4
ARG EXTENSION_BASE58_VERSION=0.1.4
ARG EXTENSION_APCU_VERSION=5.1.17
ARG EXTENSION_MEMCACHED_VERSION=3.1.5
ARG EXTENSION_REDIS_VERSION=5.2.1
ARG EXTENSION_MONGODB_VERSION=1.7.3
ARG EXTENSION_RDKAFKA_VERSION=4.0.2
ARG EXTENSION_COUCHBASE_VERSION=3.0.0beta1
ARG EXTENSION_CASSANDRA_VERSION=1.3.2
ARG EXTENSION_AMQP_VERSION=1.10.0
ARG EXTENSION_GEARMAN_VERSION=2.0.6
ARG EXTENSION_SODIUM_VERSION=2.0.22
ARG EXTENSION_MCRYPT_VERSION=1.0.3
ARG EXTENSION_SCREWIM_VERSION=1.0.1
ARG EXTENSION_EV_VERSION=1.0.8
ARG EXTENSION_UV_VERSION=0.2.4
ARG EXTENSION_EIO_VERSION=2.0.4
ARG EXTENSION_EVENT_VERSION=2.5.4
ARG EXTENSION_MEMPROF_VERSION=2.0.0
ARG EXTENSION_HTTP_VERSION=3.2.2
ARG EXTENSION_CALLEE_VERSION=0.0.0
ARG EXTENSION_DECIMAL_VERSION=1.3.1
ARG EXTENSION_IMAGICK_VERSION=3.4.4
ARG EXTENSION_VIPS_VERSION=1.0.10
ARG EXTENSION_SSH2_VERSION=1.2
ARG EXTENSION_SQLSRV_VERSION=5.8.0
ARG EXTENSION_V8JS_VERSION=2.1.1
ARG EXTENSION_V8_VERSION=0.2.2
ARG EXTENSION_OAUTH_VERSION=2.0.4
ARG EXTENSION_EXCEL_VERSION=1.0.2
ARG EXTENSION_XLSWRITER_VERSION=1.3.4.2
ARG EXTENSION_XDEBUG_VERSION=2.9.2
ARG EXTENSION_SEASLOG_VERSION=2.1.0
ARG EXTENSION_COMPONERE_VERSION=3.1.1
ARG EXTENSION_RUNKIT7_VERSION=3.1.0a1
ARG EXTENSION_VLD_VERSION=0.16.0
