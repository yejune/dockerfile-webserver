FROM yejune/webserver:bionic-7.3.4-base
...
ARG EXTENSION_PHALCON_VERSION=4.0.0-alpha.3
ARG EXTENSION_SWOOLE_VERSION=4.3.1
ARG EXTENSION_UUID_VERSION=1.0.4
ARG EXTENSION_YAML_VERSION=2.0.4
ARG EXTENSION_JSONNET_VERSION=1.3.1
ARG EXTENSION_IGBINARY_VERSION=3.0.1
ARG EXTENSION_MSGPACK_VERSION=2.0.3
ARG EXTENSION_MAILPARSE_VERSION=3.0.3
ARG EXTENSION_BASE58_VERSION=0.1.3
ARG EXTENSION_APCU_VERSION=5.1.17
ARG EXTENSION_MEMCACHED_VERSION=3.1.3
ARG EXTENSION_REDIS_VERSION=4.3.0
...
ARG EXTENSION_GEARMAN_VERSION=2.0.5
ARG EXTENSION_SODIUM_VERSION=2.0.21
...
ARG EXTENSION_XDEBUG_VERSION=2.7.1
ARG EXTENSION_SEASLOG_VERSION=2.0.2
