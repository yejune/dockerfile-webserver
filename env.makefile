...
PHP80_VERSION:=8.0.3
PHP80_SHA256:=c9816aa9745a9695672951eaff3a35ca5eddcb9cacf87a4f04b9fb1169010251
...
EXTENSION_SWOOLE_VERSION:=4.6.3
...
EXTENSION_PROTOBUF_VERSION:=3.15.5
...
EXTENSION_SQLSRV_VERSION:=5.9.0
...
EXTENSION_DATADOG_TRACE_VERSION:=0.56.0
EXTENSION_GRPC_VERSION:=1.36.0
...
EXTENSION_EXCIMER_VERSION:=1.0.0
EXTENSION_WASM_VERSION:=1.0.0
EXTENSION_ZEPHIR_PARSER_VERSION:=1.3.6
