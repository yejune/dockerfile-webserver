...
PHP83_VERSION:=8.3.7
PHP83_SHA256:=d53433c1ca6b2c8741afa7c524272e6806c1e895e5912a058494fea89988570a
...
EXTENSION_PHALCON_VERSION:=5.7.0
EXTENSION_SWOOLE_VERSION:=5.1.2
...
EXTENSION_PROTOBUF_VERSION:=4.27.0
...
EXTENSION_MONGODB_VERSION:=1.19.1
...
EXTENSION_COUCHBASE_VERSION:=4.2.1
EXTENSION_CASSANDRA_VERSION:=1.3.2
EXTENSION_AMQP_VERSION:=2.1.2
EXTENSION_GEARMAN_VERSION:=2.1.2
...
EXTENSION_XDEBUG_VERSION:=3.3.2
...
EXTENSION_DATADOG_TRACE_VERSION:=1.0.0beta1
EXTENSION_GRPC_VERSION:=1.63.0
