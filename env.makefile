...
PHP81_VERSION:=8.1.0
PHP81_SHA256:=a1317eff0723a2b3d3122bbfe107a1158570ea2822dc35a5fb360086db0f6bbc
...
EXTENSION_PHALCON_VERSION:=5.0.0alpha7
EXTENSION_SWOOLE_VERSION:=4.8.2
...
EXTENSION_XDEBUG_VERSION:=3.1.1
EXTENSION_SEASLOG_VERSION:=2.2.0
EXTENSION_COMPONERE_VERSION:=3.1.2
EXTENSION_RUNKIT7_VERSION:=4.0.0a3
EXTENSION_VLD_VERSION:=0.17.1
EXTENSION_DATADOG_TRACE_VERSION:=0.67.0
EXTENSION_GRPC_VERSION:=1.42.0
EXTENSION_PSR_VERSION:=1.1.0
...
EXTENSION_ZEPHIR_PARSER_VERSION:=1.4.1
EXTENSION_ZEPHIR_VERSION:=0.14.0
EXTENSION_AWSCRT_VERSION:=1.0.8
