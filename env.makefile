...
LIBRARY_XLSWRITER_VERSION:=0.9.1
LIBRARY_VIPS_VERSION:=8.7.0
LIBRARY_RABBITMQ_VERSION:=0.8.0

EXTENSION_PHALCON_VERSION:=4.0.4
EXTENSION_SWOOLE_VERSION:=4.4.17
EXTENSION_UUID_VERSION:=1.1.0
EXTENSION_YAML_VERSION:=2.1.0
EXTENSION_JSONNET_VERSION:=1.3.1
EXTENSION_PROTOBUF_VERSION:=3.11.4
EXTENSION_IGBINARY_VERSION:=3.1.1
EXTENSION_MSGPACK_VERSION:=2.1.0
EXTENSION_MAILPARSE_VERSION:=3.0.4
EXTENSION_BASE58_VERSION:=0.1.4
EXTENSION_APCU_VERSION:=5.1.17
EXTENSION_MEMCACHED_VERSION:=3.1.5
EXTENSION_REDIS_VERSION:=5.2.1
EXTENSION_MONGODB_VERSION:=1.7.3
EXTENSION_RDKAFKA_VERSION:=4.0.2
EXTENSION_COUCHBASE_VERSION:=3.0.0beta1
EXTENSION_CASSANDRA_VERSION:=2.4.6
EXTENSION_AMQP_VERSION:=1.10.0
EXTENSION_GEARMAN_VERSION:=2.0.6
EXTENSION_SODIUM_VERSION:=2.0.22
EXTENSION_MCRYPT_VERSION:=1.0.3
EXTENSION_SCREWIM_VERSION:=1.0.1
EXTENSION_EV_VERSION:=1.0.8
EXTENSION_UV_VERSION:=0.2.4
EXTENSION_EIO_VERSION:=2.0.4
EXTENSION_EVENT_VERSION:=2.5.4
EXTENSION_MEMPROF_VERSION:=2.0.0
EXTENSION_HTTP_VERSION:=3.2.2
EXTENSION_CALLEE_VERSION:=0.0.0
EXTENSION_DECIMAL_VERSION:=1.3.1
EXTENSION_IMAGICK_VERSION:=3.4.4
EXTENSION_VIPS_VERSION:=1.0.10
EXTENSION_SSH2_VERSION:=1.2
EXTENSION_SQLSRV_VERSION:=5.8.0
EXTENSION_V8JS_VERSION:=2.1.1
EXTENSION_V8_VERSION:=0.2.2
EXTENSION_OAUTH_VERSION:=2.0.4
EXTENSION_EXCEL_VERSION:=1.0.2
EXTENSION_XLSWRITER_VERSION:=1.3.4.2
EXTENSION_XDEBUG_VERSION:=2.9.2
EXTENSION_SEASLOG_VERSION:=2.1.0
EXTENSION_COMPONERE_VERSION:=3.1.1
EXTENSION_RUNKIT7_VERSION:=3.1.0a1
EXTENSION_VLD_VERSION:=0.16.0
EXTENSION_DATADOG_TRACE_VERSION:=0.42.0
EXTENSION_GRPC_VERSION:=1.28.0
EXTENSION_PSR_VERSION:=1.0.0
EXTENSION_YACONF_VERSION:=1.0.8
EXTENSION_HTTP_MESSAGE_VERSION:=0.2.1
