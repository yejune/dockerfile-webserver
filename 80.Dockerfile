FROM yejune/webserver:focal-8.0.3-base
...
ARG EXTENSION_SWOOLE_VERSION=4.6.3
...
ARG EXTENSION_PROTOBUF_VERSION=3.15.5
...
ARG EXTENSION_EV_VERSION=1.1.0
...
ARG EXTENSION_SQLSRV_VERSION=5.9.0
...
ARG EXTENSION_DATADOG_TRACE_VERSION=0.56.0
ARG EXTENSION_GRPC_VERSION=1.36.0
ARG EXTENSION_PSR_VERSION=1.0.0
ARG EXTENSION_YACONF_VERSION=1.1.0
ARG EXTENSION_HTTP_MESSAGE_VERSION=0.2.2
ARG EXTENSION_WASM_VERSION=1.0.0
ARG EXTENSION_ZEPHIR_PARSER_VERSION=1.3.6
ARG EXTENSION_GEOSPATIAL_VERSION=0.3.1
ARG EXTENSION_EXCIMER_VERSION=1.0.0
