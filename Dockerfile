...
ARG PHP_SHA256="1f004e049788a3effc89ef417f06a6cf704c95ae2a718b2175185f2983381ae7"
...
ARG EXTENSION_IGBINARY_VERSION=2.0.6
...
ARG EXTENSION_MONGODB_VERSION=1.4.4
...
ARG EXTENSION_PHALCON_VERSION=3.4.0
ARG EXTENSION_SODIUM_VERSION=2.0.11
...
ARG EXTENSION_SWOOLE_VERSION=4.0.0
ARG EXTENSION_HTTP_VERSION=3.1.0
ARG EXTENSION_XLSWRITER_VERSION=1.2.1
