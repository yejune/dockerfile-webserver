...
ARG EXTENSION_PHALCON_VERSION=5.0.0beta3
ARG EXTENSION_SWOOLE_VERSION=4.8.7
...
ARG EXTENSION_PROTOBUF_VERSION=3.20.0RC1
ARG EXTENSION_IGBINARY_VERSION=3.2.7
...
ARG EXTENSION_MONGODB_VERSION=1.12.1
...
ARG EXTENSION_XDEBUG_VERSION=3.1.3
...
ARG EXTENSION_GRPC_VERSION=1.44.0
...
ARG EXTENSION_ZEPHIR_PARSER_VERSION=1.5.0
ARG EXTENSION_ZEPHIR_VERSION=0.15.2
